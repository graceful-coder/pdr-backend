...
sys.path.append('/Users/foxylady/pdr-backend/pdr_backend')
# from trader.trader_agent import TraderAgent
# from trader.trader_config import TraderConfig
...
class PDR(DirectionalStrategyBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # trader_config = TraderConfig()  # Configure as needed
        # self.trader_agent = TraderAgent(trader_config)
    ...
    # prediction = self.trader_agent.get_latest_prediction("0x8165caab33131a4ddbf7dc79f0a8a4920b0b2553") #This is has the BTC-USDT feed id hardcoded

    # prediction = self.trader_agent.get_latest_prediction("0xf2f483e23dc1e316ac4894dcabf98ea2e6b972ec") #This is has the BTC-USDT feed's NFT id hardcoded
